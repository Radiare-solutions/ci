                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-12 col-xs-12">
                                                        ...
                                                        <div class="col-md-3 text-center pull-right">
                                                                <strong class="text-lg">Status</strong><br/>
                                                                <span class="text"><?php echo $detail['status_name']; ?></span>
                                                        </div>
                                                        <div class="col-md-3 text-center pull-right">
                                                ...
                                                <div class="col-md-12 col-xs-12">
                                                        ...
                                                        <div class="col-md-3 text-center pull-right">
                                                            ...
                                                            <?php 
                                                            if(trim($detail['collaborator'])!="" || trim($detail['collaborator'])!=null){
 ...
 <?php echo $detail['detailed_intervention']; ?>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                        <div class="card no-margin">
                                                                <div class="card-body">
                                                            <?php if($detail['detailed_desc']!=""){ echo $detail['detailed_desc']; }else{
                                                                echo "Not Provided";
                                                            } ?>
