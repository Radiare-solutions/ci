...
<html>
    ...
    <body class="horizontal-menu">
        ...
        <script src="{{ URL::asset("js/plugins/dom-to-image.js") }}"></script>
    ...
    $("#" + data[i]["attr"]["id"]).css("color", colors[i]);
            ...
            function div2image(div_id) {
                ...
                domtoimage.toPng(node)
                        .then(function (dataUrl) {
                            dataUrl = dataUrl.replace('data:image/png;base64,', 'data:application/octet-stream;base64,');
                            window.open(dataUrl);
                        })
        ...
        <script>
            ...
            function exportImageAsPNG(div_id) {
                var svgElement = document.getElementById(div_id); //.querySelector('condition');
                ...
                // var data = 'data:image/png;base64,'+btoa(($('#condition').html()));
                var data = 'data:image/png;base64,' + btoa($("#" + div_id).html());
